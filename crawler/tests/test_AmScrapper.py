...
class TestRequester(IsolatedAsyncioTestCase):
    ...
    async def test_requester_easy_one(self):
        url = "https://www.amazon.com/HP-Business-Dual-core-Bluetooth-Legendary/product-reviews" \
...
class TestCheckLanguageContent(TestCase):
    ...
    def test_requester_easy_one(self):
        ...
        self.assertEqual(self.testScrapereasy.check_language_content(input["REVIEW #1"]), False)
